...
New Game starts fresh in one of three save slots. Continue loads a save's
upgrade map. Each slot keeps separate currency, upgrades, mode and launch
music. Replacing an occupied slot requires confirmation. Existing progress
...
press Enter/X (controller A) or click the button to open upgrades. Scores are

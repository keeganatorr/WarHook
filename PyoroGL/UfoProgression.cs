...
namespace MonogameTest
{
    enum UfoUpgradeEffect { Fire, Tractor, Engine, Hull, Capacity, Growth, StartingBonus, BeamWidth, Repair, SoldierValue,
        ...
        LongHaul, Interest, Exponential, Prestige, FlightClearance, Shield, AutoFire }
    ...
    sealed class UfoProgression
    {
        ...
        public static readonly UfoUpgrade[] Nodes = {
            ...
            new("auto-fire", "ROCKET INTERCEPT", "INTERCEPT", UfoUpgradeEffect.AutoFire, 1f, 60, 1, UfoBranch.Weapons, new Vector2(-235, -5), new UfoPrerequisite[] { new("point", 1) }),
        };
